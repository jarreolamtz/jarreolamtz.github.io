...
function cursorfollow() {
  ...
  $(".cur, a, .icon-menu, input, textarea, #section-02 .controls .box.mid, #section-02 .controls .box .image.mid").on("mouseenter", function() {
    follower.addClass("active"),
    cursor.addClass("active"),
    $(".hover").addClass("hovered"),
    $(this).removeClass("hovered")
  }),
  $(".cur, a, .icon-menu, input, textarea, #section-02 .controls .box.mid, #section-02 .controls .box .image.mid").on("mouseleave", function() {
